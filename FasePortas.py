...
def portas_logicas():
    ...
    solucao = [1, 0, 0, 1, 0, 1]  # Sequência de ativação
    
    # Estados dos interruptores
    interruptores = [0, 0, 0, 0, 0, 0]
    
    # Posições
    interruptor_posicoes = [(100, 50), (100, 140), (100, 230), (100, 320), (100, 410), (100, 500)]
    porta_xor_posicoes = [(300, 110), (300, 270), (300, 420)]
    porta_and_posicoes = [(500, 180), (500, 360)]
    lampada_posicao = (700, 250)
            ...
            if evento.type == MOUSEBUTTONDOWN:
                ...
                if lampada_estado:
                    ...
                    if botao_rect.collidepoint(x, y):
                        creditos()  # Aqui pode ser chamada a próxima fase do jogo
